...
public class MonadOlayController {
    ...
    @Operation(description = "Monad servis üzerinden ilişkili sözel order detaylarını getirir")
    ...
    @Operation(description = "Monad servis üzerinden ilişkili panik deger detaylarını getirir")
    ...
    @Operation(description = "Monad servis üzerinden ilişkili panik deger islem listesi detaylarını getirir")
    ...
    @Operation(description = "Monad servis üzerinden ilişkili radyoloji panik deger detaylarını getirir")
    ...
    @Operation(description = "Monad servis üzerinden ilişkili radyoloji panik deger islem listesi  detaylarını getirir")
